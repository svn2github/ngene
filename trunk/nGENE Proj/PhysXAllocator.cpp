...
//----------------------------------------------------------------------
	void* PhysXAllocator::malloc(NxU32 size)
	{
...
//----------------------------------------------------------------------
	void* PhysXAllocator::malloc(NxU32 size, NxMemoryType type)
	{
		//	return ::malloc(size);
...
//----------------------------------------------------------------------
	void* PhysXAllocator::mallocDEBUG(NxU32 size, const char* file, int line)
	{
		printf("Obsolete code called!\n");
		return NULL;
	}
//----------------------------------------------------------------------
	void* PhysXAllocator::mallocDEBUG(NxU32 size, const char* file, int line, const char* className, NxMemoryType type)
	{
...
//----------------------------------------------------------------------
	void* PhysXAllocator::realloc(void* memory, NxU32 size)
	{
...
//----------------------------------------------------------------------
	void PhysXAllocator::free(void* memory)
	{
		//	::free(memory);	return;
