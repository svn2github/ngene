...
void App::createApplication()
{
	...
	pLight->setPosition(-4.0f, 5.0f, 6.0f);
	...
	// Create gui
	static GUIFont* pFont = new GUIFont(L"gui_default_font.fnt");
	m_pWindow = new MyWindow(this);

	GUIManager::getSingleton().setFont(pFont);
	GUIManager::getSingleton().addWindow(m_pWindow);
